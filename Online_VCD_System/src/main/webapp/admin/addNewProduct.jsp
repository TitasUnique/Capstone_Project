...
body
{
background-image: url(https://images.pexels.com/photos/4158/apple-iphone-smartphone-desk.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);
...
<h2 style="color: yellow;">Product ID:<% out.println(id); %> </h2>
